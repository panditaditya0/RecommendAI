...
public class SearchProductServiceImpl implements SearchProductService {
    ...
    public LinkedHashSet<ResponsePayload> getSimilarProductOfDifferentDesigner(RequestPayload requestPayload) {
        ...
        if (listOfSkuIdsFromRedis.size() >0) {
            return prepareProductDetails(listOfSkuIdsFromRedis, requestPayload);
        }
        ...
        return prepareProductDetails(listOfSkuIdsFromWeaviateDb, requestPayload);
    }
    ...
    public LinkedHashSet<ResponsePayload> getSimilarProductOfSameDesigner(RequestPayload requestPayload) {
        ...
        if(productDetails.base64Image == null && productDetails.image_link != null){
            //SendToKafka
            return new LinkedHashSet<ResponsePayload>();
        }
    ...
    public LinkedHashSet<ResponsePayload> getRecentlyViewed(RequestPayload requestPayload) {
        ...
        if (requestPayload.user_id != ""){
            ...
            return prepareProductDetails(listOfSkus, requestPayload);
        } else {
    ...
    private LinkedHashSet<ResponsePayload> prepareProductDetails(LinkedHashSet<String> listOfSkuIdsFromRedis, RequestPayload requestPayload) {
